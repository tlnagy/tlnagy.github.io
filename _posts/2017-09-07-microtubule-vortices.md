...
layout: post
tags: [science, math]
thumbnail: assets/img/2017-09-07-microtubule-vortices/mt_vortices.gif
date: 2017-09-07 12:00:00
redirect_from: /blog/microtubule-vortices/
---
...
{% include figure.liquid loading="eager" path="assets/img/2017-09-07-microtubule-vortices/0de43a55.png" class="img-fluid rounded z-depth-1" caption="Figure 1A-B from @Sumino2012-dc. Cy3 labeled microtubules form vortices when placed on dynein-c coated glass coverslips in the presence of ATP" %}
...
{% include figure.liquid loading="eager" path="assets/img/2017-09-07-microtubule-vortices/mt_initial.gif" class="img-fluid rounded z-depth-1" caption="Initially, microtubule movement looks pretty random." %}

{% include figure.liquid loading="eager" path="assets/img/2017-09-07-microtubule-vortices/mt_vortices.gif" class="img-fluid rounded z-depth-1" caption="However, they start to coalesce into a grid of vortices" %}
